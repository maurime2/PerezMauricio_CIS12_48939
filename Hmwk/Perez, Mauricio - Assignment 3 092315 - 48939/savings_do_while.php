		...
		<?php
        	/*	Mauricio S. Perez
				...
				Purpose:	Logical Operators
							Complete Dr. Lehr's Savings Do-While-Loop Table.
    ...
    <body>
		<?php
			 ...
			 do{
				 ...
				 echo '</tr>';
			 }while(++$year<=$nYears);   //Points to next year until 
										//years is one more than Number of years
        	 echo '</table>';
        ?>
    </body>
</html>